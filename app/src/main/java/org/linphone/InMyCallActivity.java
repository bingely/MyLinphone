...
public class InMyCallActivity extends FragmentActivity implements View.OnClickListener{
    private final static int SECONDS_BEFORE_HIDING_CONTROLS = 3000;
    private final static int SECONDS_BEFORE_DENYING_CALL_UPDATE = 30000;

    private static InMyCallActivity instance;
  ...
  @Override
    ...
    private void showAudioView() {
        ...
        LinphoneManager.startProximitySensorForActivity(InMyCallActivity.this);
    ...
    private void showVideoView() {
        ...
        LinphoneManager.stopProximitySensorForActivity(InMyCallActivity.this);
        ...
        if (isTransferAllowed) {
            animation.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    transfer.setVisibility(View.INVISIBLE);
                    animation = AnimationUtils.loadAnimation(InMyCallActivity.this, R.anim.slide_out_top_to_bottom); // Reload animation to prevent transfer button to blink
                    animation.setAnimationListener(new Animation.AnimationListener() {
                        @Override
                        public void onAnimationStart(Animation animation) {
                        }
    ...
    private void refreshInCallActions() {
        ...
        if (LinphoneManager.getLc().getCallsNb() > 1) {
            ...
            List<LinphoneCall> pausedCalls = LinphoneUtils.getCallsInState(LinphoneManager.getLc(), Arrays.asList(LinphoneCall.State.Paused));
